...
import  TerminalSetiingDashboardLayout from "../pageObject/terminal_Setting_Dashboard_Layout.js";
...
describe('Terminal_Setting : Dashboard Layout', () => {
...
it('Terminal  Page', () => {
    ...
    //write code for Terminal Setting Dashboard Layout

    terminalSetiingDashboardLayoutObj.getclickOnDashboardLayoutOption().click();
    //terminalSetiingDashboardLayoutObj.getdashboardLandingPage().should("exist");
    terminalSetiingDashboardLayoutObj.getremoveCheckOutbtnStaus().eq(0).should('exist');
    terminalSetiingDashboardLayoutObj.getremoveCheckInbtnStatus().eq(0).should('exist');
    terminalSetiingDashboardLayoutObj.getremoveRequestMeetingStatus().eq(0).should('exist');
    terminalSetiingDashboardLayoutObj.getsaveBtnofTerminalDashboardLayout().click();
