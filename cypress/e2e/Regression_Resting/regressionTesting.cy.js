...
// Write the hook for loading the fixture file and execute only once 
...
createSingleInviteObj.enterAgendaFormField(userdata.agendaOfMeeting);
...
it('Terminal Setting : authorization Page', () => {
...
it('Terminal Setting : Badge Print Page', () => {
